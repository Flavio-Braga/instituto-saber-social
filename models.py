...
class Atendido(db.Model):
    ...
    frequencias = db.relationship('Frequencia', backref='atendido', lazy=True)

    def __init__(self, nome, status=True):
        self.nome = nome
        self.status = status
...
class Colaborador(db.Model):
    ...
    frequencias = db.relationship('Frequencia', backref='colaborador', lazy=True)

    def __init__(self, nome_completo, senha, cargo, email, telefone=None):
